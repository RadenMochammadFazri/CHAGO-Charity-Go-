...
public class PembayaranPribadi {

    public PembayaranPribadi(){
    ...
    public void BtnHPPP(ActionEvent event) throws IOException{
        Main m = new Main();

        m.changeScene("FXMLHomepg.fxml");
    }
    public void BtnNotif(ActionEvent event) throws IOException{
        Main m = new Main();

        m.changeScene("FXMLNotifPribadi.fxml");
    }
